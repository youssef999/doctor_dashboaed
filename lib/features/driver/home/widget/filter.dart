...
class PopupView extends StatelessWidget {
  ...
  Widget _buildToggleButtons(
      String title, List<String> options, RxString selectedOption) {
    return Padding(
          ...
          Obx(() {
            return FlutterSlider(
              ...
              trackBar: FlutterSliderTrackBar(
                ...
                activeTrackBar:const BoxDecoration(color: Color.fromRGBO(127, 228, 126, 1)),
                inactiveTrackBar: BoxDecoration(color: AppColors.greyColor.withOpacity(.2)),
              ...
              hatchMark: FlutterSliderHatchMark(
                ...
                //smallLine: FlutterSliderSizedBox(height: 100, width: 20,decoration: BoxDecoration(color:Colors.red)),
                density: 0.5,
                labels: [
