         ...
         child: GetBuilder<CompController>(
           builder: (_) {
             return ListView(children: [
               SizedBox(height: 12,),
               (controller.numData.length==0)?Center(child: CircularProgressIndicator(),):
               Row(
                 mainAxisAlignment:MainAxisAlignment.center,
                 children: [
                 CardWidget(txt: 'عدد المستخدمين', num: controller.numData['user_count'].toString()),
                 SizedBox(width: 33,),
                 CardWidget(txt: 'عدد الاطباء', num: controller.numData['doctor_count'].toString()),
               ],)
             ],);
           }
         ),
